...
//✅ ADD THIS METHOD
	public java.util.List<ProjectProposal> getAll() {
	...
	public ProjectProposal update(String pid, ProjectRequest req, String currentUid) {
		...
		var existing = projects.findById(pid).orElseThrow(() -> new IllegalArgumentException("Project not found"));
	...
	public ProjectProposal get(String pid, String currentUid) {
		var p = projects.findById(pid).orElseThrow(() -> new IllegalArgumentException("Project not found"));
